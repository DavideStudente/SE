...
@WebService(endpointInterface = "bankServer.BankInterface")
public class BankImpl implements BankInterface {
    ...
    private ArrayList<String[]> chargeOperations() {
        ...
        result.add(new String[]{"9", "1", "2019-07-05", "75", "Benzina Autostrada"});
        result.add(new String[]{"10", "4", "2019-07-05", "75", "Benzina Autostrada"});
