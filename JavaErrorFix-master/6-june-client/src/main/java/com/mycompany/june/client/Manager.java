 ...
 */
package com.mycompany.june.client;

import com.mycompany.june.serv.ServerMethods;
import com.mycompany.june.serv.ServerMethodsInterface;
...
import com.mycompany.june.serv.*;
...
public class Manager implements MessageListener {
    ...
    private static Professor getProfDetails(int arg0) {
        ServerMethods service = new com.mycompany.june.serv.ServerMethods();
        ServerMethodsInterface port = service.getServerMethodsPort();
