 ...
 * 
 */
@WebServiceClient(name = "ExamImplService", targetNamespace = "http://server.june.mycompany.com/", wsdlLocation = "http://localhost:8080/ProfessorManagement?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EXAMIMPLSERVICE_QNAME = new QName("http://server.june.mycompany.com/", "ExamImplService");
    ...
    public Exam getExamImplPort() {
        return super.getPort(new QName("http://server.june.mycompany.com/", "ExamImplPort"), Exam.class);
    }
    ...
    public Exam getExamImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.june.mycompany.com/", "ExamImplPort"), Exam.class, features);
    }
