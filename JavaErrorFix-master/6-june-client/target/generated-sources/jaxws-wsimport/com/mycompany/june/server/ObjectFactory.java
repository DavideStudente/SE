 ...
 * generated in the com.mycompany.june.server package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetDetails_QNAME = new QName("http://server.june.mycompany.com/", "getDetails");
    private final static QName _Professor_QNAME = new QName("http://server.june.mycompany.com/", "professor");
    private final static QName _GetDetailsResponse_QNAME = new QName("http://server.june.mycompany.com/", "getDetailsResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.mycompany.june.server
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.june.mycompany.com/", name = "getDetails")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.june.mycompany.com/", name = "professor")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.june.mycompany.com/", name = "getDetailsResponse")
