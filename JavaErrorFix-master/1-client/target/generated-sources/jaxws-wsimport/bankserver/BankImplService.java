 ...
 * 
 */
@WebServiceClient(name = "BankImplService", targetNamespace = "http://bankServer/", wsdlLocation = "http://localhost:9000/bank?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANKIMPLSERVICE_QNAME = new QName("http://bankServer/", "BankImplService");
    ...
    public BankInterface getBankImplPort() {
        return super.getPort(new QName("http://bankServer/", "BankImplPort"), BankInterface.class);
    }
    ...
    public BankInterface getBankImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://bankServer/", "BankImplPort"), BankInterface.class, features);
    }
