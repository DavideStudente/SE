 ...
 * generated in the bankserver package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetOperationDetailsByID_QNAME = new QName("http://bankServer/", "getOperationDetailsByID");
    private final static QName _GetOperationDetailsByIDResponse_QNAME = new QName("http://bankServer/", "getOperationDetailsByIDResponse");
    private final static QName _GetOperationsByClientIDResponse_QNAME = new QName("http://bankServer/", "getOperationsByClientIDResponse");
    private final static QName _GetOperationsByClientID_QNAME = new QName("http://bankServer/", "getOperationsByClientID");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: bankserver
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bankServer/", name = "getOperationDetailsByID")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bankServer/", name = "getOperationDetailsByIDResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bankServer/", name = "getOperationsByClientIDResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bankServer/", name = "getOperationsByClientID")
