 ...
 * generated in the com.mycompany.bankserver package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetClientsResponse_QNAME = new QName("http://bankserver.mycompany.com/", "getClientsResponse");
    private final static QName _GetClients_QNAME = new QName("http://bankserver.mycompany.com/", "getClients");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.mycompany.bankserver
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bankserver.mycompany.com/", name = "getClientsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bankserver.mycompany.com/", name = "getClients")
